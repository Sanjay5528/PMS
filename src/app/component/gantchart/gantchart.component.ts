...
import { GanttBarClickEvent, GanttBaselineItem, GanttDragEvent, GanttGroup, GanttItem, GanttLineClickEvent, GanttLinkDragEvent, GanttPrintService, GanttSelectedEvent, GanttTableDragDroppedEvent, GanttTableDragEndedEvent, GanttTableDragEnterPredicateContext, GanttTableDragStartedEvent, GanttToolbarOptions, GanttView, GanttViewOptions, GanttViewType, NgxGanttComponent } from '@worktile/gantt';
...
@Component({
  ...
  styleUrls: ['./gantchart.component.scss']
})
